...
public class Constantes {
    ...
    public final static String PAQUETE_APP = "com.rsanalytics";
    ...
    public final static String RUTA_RELATIVA_MANEJADORES = "com/rsanalytics/controlador/rest/handlers";
    public final static String PAQUETE_MANEJADORES = PAQUETE_APP + ".controlador.rest.handlers";
    ...
    public final static String RUTA_JSONS_MODO_PRUEBA = Constantes.RUTA_DIRECTORIO_RSANALYTICS + "/JSONS";

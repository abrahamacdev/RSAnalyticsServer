...
public class TipoInmueble {
    ...
    public boolean es(com.rsanalytics.utilidades.inmuebles.TipoInmueble tipoInmueble){
        return id == tipoInmueble.id;
    }

    public com.rsanalytics.utilidades.inmuebles.TipoInmueble tipoInmuebleAsEnum(){
        return com.rsanalytics.utilidades.inmuebles.TipoInmueble.obtenerPorId(id);
    }

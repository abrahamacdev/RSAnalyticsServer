...
public class PrimeraVez {
    ...
    private boolean copiarPlantillas2DirectorioRecursos(){
        ...
        File plantillas = new File(this.getClass().getResource("../plantillas").getPath());
    ...
    private boolean copiarArchivosConf2DirectorioConf() {
        ...
        File configuracion = new File(this.getClass().getResource("../conf").getPath());
        ...
        File chromeDriverSrc = new File(this.getClass().getResource("../chromeDriver/chromedriver").getPath());
